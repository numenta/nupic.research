...
GSC_SPARSE_MAP = {
    ...
    "linear/kernel:0": ("linear.module.weight", reflatten_linear_weight),
...
def load_weights(model_tf, model_pt, weights_map):
    """
    Load pre-trained model weights from pytorch to tensorflow
...
if __name__ == "__main__":
    ...
    load_weights(model_tf, model_pt, GSC_SPARSE_MAP)
