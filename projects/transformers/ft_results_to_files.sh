...
# 
CSV=~/nta/finetuning/finetuning_results.csv
rm ${CSV}
...
python export_finetuning_results.py ~/nta/finetuning/finetuning_bert_sparse_trifecta_100k_glue_get_info_nb --model_name trifecta_80_100k_glue_get_info_nb --csv ${CSV} --md "finetuning_results.md"