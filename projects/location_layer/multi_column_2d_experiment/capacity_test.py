...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--columns", default=1, type=int, help="number of cortical columns"
    )
    ...
    for i in range(NUM_OBJECTS):
        ...
        objLoc = (np.random.randint(OBJ_MAX_DIM), np.random.randint(OBJ_MAX_DIM))
        OBJECT_PLACEMENTS_LEARN[objName] = objLoc

    print(
        "Columns: {} Features: {} Objects: {}".format(
            args.columns, args.features, args.objects
        )
    )
