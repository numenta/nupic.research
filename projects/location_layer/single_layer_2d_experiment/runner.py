...
class SingleLayerLocation2DExperiment(object):
    ...
    def doTimestep(
        self, locationSDR, transitionSDR, featureSDR, egocentricLocation, learn
    ):
        """
        Run one timestep.
        """
        ...
        for monitor in list(self.monitors.values()):
            monitor.beforeTimestep(
                locationSDR, transitionSDR, featureSDR, egocentricLocation, learn
            )
    ...
    def learnTransitions(self):
        ...
        for (i, j), _locationSDR in self.locations.items():
            print("i, j", (i, j))
    ...
    def learnObjects(self, objectPlacements):
        ...
        for objectName, objectDict in self.objects.items():
            ...
            for locationName, featureName in objectDict.items():
                egocentricLocation = (
                    locationName[0] + objectPlacement[0],
    ...
    def _selectTransition(self, allocentricLocation, objectDict, visitCounts):
        ...
        candidates = list(
            ...
            if (
                allocentricLocation[0] + transition[0],
    ...
    def inferObject(
        ...
        try:
            while True:
                ...
                egocentricLocation = (
                    allocentricLocation[0] + objectPlacements[objectName][0],
                    allocentricLocation[1] + objectPlacements[objectName][1],
                )
                featureSDR = self.features[featureName]
                ...
                allocentricLocation = (
                    allocentricLocation[0] + transitionName[0],
    ...
    def inferObjectsWithRandomMovements(
        self, objectPlacements, maxTouches=20, settlingTime=2
    ):
        """
        ...
        for objectName, objectDict in self.objects.items():
            ...
            for _ in range(maxTouches):
                ...
                if (
                    ...
                    and set(self.locationLayer.getActiveCells())
