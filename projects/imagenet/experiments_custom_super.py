...
def my_auto_sparse_conv_params(in_channels, out_channels, kernel_size):
    ...
    if weights_per_channel < 100:
        ...
        weights_density = 0.18

    elif weights_per_channel < 4000:
        weights_density = 0.09

    else:
        weights_density = 0.08
...
DEBUG_CUSTOM_LR = copy.deepcopy(DEBUG_CUSTOM)
DEBUG_CUSTOM_LR.update(dict(
    epochs=20,
    log_level="debug",
    num_classes=3,
...
CUSTOM_CONFIG = dict(
    ...
    debug_custom_lr=DEBUG_CUSTOM_LR,
