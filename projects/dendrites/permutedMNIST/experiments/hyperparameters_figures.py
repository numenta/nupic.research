...
def first_iteration():
    ...
    experiment_folder = (
        "/home/jeremy/nta/results/experiments/dendrites/cns_abstract_2021/"
    )
    ...
    sigma = 0.2
    fig.suptitle(
        "Impact of the different hyperparameters on performance - \n \
                 full cross product of hyperparameters ",
        fontsize=12,
    )
    ...
    fig2.suptitle(
        "Impact of each hyperparameter given other hyperparamers fixed \n \
                  to their best value for best accuracy",
        fontsize=16,
    )
...
def second_iteration():
    ...
    experiment_folder = (
        "/home/jeremy/nta/results/experiments/dendrites/cns_abstract_2021_2/"
    )
...
def third_iteration():
    ...
    ax2.set(ylabel="")
    ax2.set(xticklabels=["0.99", "0.95", "0.9", "0.8", "0.6", "0.4", "0.2", "0.1"])
    ax3.set(ylabel="")
...
def cns_figure_1c():
    ...
    experiment_folder1 = (
        "/home/jeremy/nta/results/experiments/dendrites/nb_segment_search2/"
    )
    df_path1 = f"{experiment_folder1}temp.csv"
    df1 = pd.read_csv(df_path1)

    experiment_folder1bis = (
        "/home/jeremy/nta/results/experiments/dendrites/nb_segment_search3/"
    )
    df_path1bis = f"{experiment_folder1bis}temp.csv"
    df1bis = pd.read_csv(df_path1bis)

    experiment_folder2 = (
        "/home/jeremy/nta/results/experiments/dendrites/kw_sparsity_search/"
    )
    df_path2 = f"{experiment_folder2}temp.csv"
    df2 = pd.read_csv(df_path2)
    ...
    if savefigs:
        plt.savefig(f"{figs_dir}/cns2021_figure1c.png", bbox_inches="tight", dpi=1200)
