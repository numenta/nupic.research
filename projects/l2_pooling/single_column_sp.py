...
def runSharedFeatures(noiseLevel=None):
    ...
    """
    exp = L4L2Experiment(
        "shared_features", enableLateralSP=True, enableFeedForwardSP=True
    )
    ...
    inferConfig = {
        ...
        "pairs": {0: list(zip(list(range(10)), list(range(10))))},
    }
...
def runUncertainLocations(missingLoc=None):
    ...
    exp = L4L2Experiment(
        "uncertain_location", enableLateralSP=True, enableFeedForwardSP=True
    )
...
def runStretchExperiment(numObjects=25):
    ...
    """
    exp = L4L2Experiment(
        "profiling_experiment", enableLateralSP=True, enableFeedForwardSP=True
    )
