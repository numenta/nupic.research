...
def generate_image_objects(data_set, num_samples_per_class, objectWidth, locationModuleWidth, data_set_section='SDR_classifiers_training', sanity_check=None):

	print("Loading " + data_set_section + " data-set from " + data_set)
	input_data = np.load('training_and_testing_data/' + data_set + '_SDRs_' + data_set_section + '.npy')
	labels = np.load('training_and_testing_data/' + data_set + '_labels_' + data_set_section + '.npy')
	images = np.load('training_and_testing_data/' + data_set + '_images_' + data_set_section + '.npy')
...
if __name__ == '__main__':
	...
	generate_image_objects(data_set='mnist', numObjects=10, objectWidth=5, locationModuleWidth=50)
