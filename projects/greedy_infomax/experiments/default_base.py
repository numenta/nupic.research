...
class GreedyInfoMaxExperiment(mixins.LogEveryLoss,
...
supervised_dataset_args.update(dict(transform=transform_supervised,
                                      split="train"))
validation_dataset_args = deepcopy(base_dataset_args)
validation_dataset_args.update(dict(transform=transform_valid,
                                      split="test"))
