...
class TrackStatsHookBase(metaclass=abc.ABCMeta):
    ...
    provides a simple API to turn off and on tracking (say to only track during a
    ...
    def __call__(self, *args):
        ...
        how the hook is registered. Accordingly, the arguments will vary. A forward
        pass will have a signature of `__call__(module, forward_input, forward_ouput)`
        and, similarly, a backward pass will have a signature of `__call__(module,
