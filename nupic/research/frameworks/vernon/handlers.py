...
from nupic.research.frameworks.vernon import core_mixins, experiments, mixins
...
class ImagenetExperiment(mixins.ExtraValidations,
                         core_mixins.StepBasedLogging,
                         SupervisedExperiment):
    """
