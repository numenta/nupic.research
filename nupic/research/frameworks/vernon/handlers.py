...
class SupervisedExperiment:
    ...
    def get_state(self):
        ...
        :return: dictionary with "model" and "optimizer" states
        """
        state = {
    ...
    def set_state(self, state):
        ...
        :param state: dictionary with "model", "optimizer", and "amp" states
        """
        if "model" in state:
...
class ImagenetExperiment(expansions.FixedLRSchedule,
                         SupervisedExperiment):
    """
