...
__all__ = [
    "AlexNetBinaryActivation",
    "gsc_alexnet_binaryactivation",
]


class AlexNetBinaryActivation(nn.Sequential):

    def __init__(self, input_size, num_classes,
                 bn_track_running_stats=True):
        ratio_infl = 3

        nonlin_params = dict(neg1_activation=True,
                             cancel_gradient=True,
                             inplace=False)
        ...
        super().__init__(OrderedDict([
            ...
            ("cnn1_nonlin", HeavisideStep(**nonlin_params)),
            ...
            ("cnn2_bn", nn.BatchNorm2d(
                ...
                affine=False,
                track_running_stats=bn_track_running_stats)),
            ("cnn2_nonlin", HeavisideStep(**nonlin_params)),
            ...
            ("cnn3_bn", nn.BatchNorm2d(
                ...
                affine=False,
                track_running_stats=bn_track_running_stats)),
            ("cnn3_nonlin", HeavisideStep(**nonlin_params)),
            ...
            ("cnn4_bn", nn.BatchNorm2d(
                ...
                affine=False,
                track_running_stats=bn_track_running_stats)),
            ("cnn4_nonlin", HeavisideStep(**nonlin_params)),
            ...
            ("cnn5_bn", nn.BatchNorm2d(
                ...
                affine=False,
                track_running_stats=bn_track_running_stats)),
            ("cnn5_nonlin", HeavisideStep(**nonlin_params)),
            ...
            ("fc1_bn", nn.BatchNorm1d(
                ...
                affine=False,
                track_running_stats=bn_track_running_stats)),
            ("fc1_nonlin", HeavisideStep(**nonlin_params)),
            ...
            ("fc2_bn", nn.BatchNorm1d(
                ...
                affine=False,
                track_running_stats=bn_track_running_stats)),
            ("fc2_nonlin", HeavisideStep(**nonlin_params)),
...
gsc_alexnet_binaryactivation = partial(AlexNetBinaryActivation,
                                       input_size=(1, 32, 32),
                                       num_classes=12)
