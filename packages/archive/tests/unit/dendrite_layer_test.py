...
from nupic.research.archive.continual_learning.dend_kwinners import (
    DendriteKWinners2d,
    DendriteKWinners2dLocal,
)
from nupic.research.archive.continual_learning.dendrite_layers import DendriteOutput
